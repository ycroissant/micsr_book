...
$$
@SMIT:BLUN:86\index[author]{Smith}\index[author]{Blundell} proposed an endogeneity test based on the two-steps estimator. As for the linear instrumental variable estimator, it is a Wald test that $\rho = 0$, but it uses the simple probit estimation of the covariance matrix.
...
As an example, we consider the article of @ABIA:MODY:05\index[author]{Abiad}\index[author]{Mody} which study
