...
Therefore, adding ability as a covariate
...
covariates to the demand and to the supply side of the market. @MADD:LAHI:09, pp.
...
@ANGR:90 studied whether veterans (in his article of the Vietnam war)
...
Minimizing this quadratic form leads to the **general method of moments** (**GMM**) estimator, also called the **two-stage IV** estimator.^[@CAME:TRIV:05, page 187.]
...
The **three stage least squares** estimator^[@ZELL:THEI:62.] (**3SLS** in short) minimizes the quadratic form
...
variable on the instruments.^[See @BOUN:JAEG:BAKE:95 and @CAME:TRIV:05 pages 108-109 for a
