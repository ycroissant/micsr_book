...
`toronto_montreal`,^[Used in particular by @FORI:KOPP:93\index[author]{Forinash}\index[author]{Koppleman},
  @BHAT:95\index[author]{Bhat}, @KOPP:WEN:98\index[author]{Koppelman}\index[author]{Wen} and @KOPP:WEN:00.] is an example of a data set in long format. It presents the choice of individuals for a transport mode for the Toronto-Montreal corridor:
...
\idxfun{fitted}{stats}\idxfun{head}{base}
...
- the Choleski decomposition used should relies on the same\index[general]{Choleski decomposition}
