...
sum(eps * hat_y)
```
We can also check that the residuals are "smaller" than the errors by computing their standard deviations:\idxfun{sd}{base}
...
\idxfun{summarise}{dplyr}\idxfun{sd}{base}\idxfun{mean}{base}
```{r}
...
\idxfun{nest}{tidyr}\idxfun{transmute}{dplyr}\idxfun{map}{purrr}\idxfun{summarise}{dplyr}\idxfun{sd}{base}\idxfun{mean}{base}
