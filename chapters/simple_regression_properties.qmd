...
sample standard deviation $\hat{\sigma}_x$:\idxfun{pull}{dplyr}\idxfun{length}{base}\idxfun{mean}{base}\idxfun{sd}{stats}
...
error:\idxfun{resid}{stats}\idxfun{sum}{base}\idxfun{sqrt}{base}
...
`FALSE`.\idxfun{pnorm}{stats}\idxfun{abs}{base}
...
for `lm` objects:\idxfun{summary}{base}
...
coefficients:\idxfun{confint}{stats}
...
sab
```
\idxfun{sqrt}{base}\idxfun{mean}{base}\idxfun{coef}{stats}\idxfun{sigma}{stats}\idxfun{unname}{base}\idxfun{nobs}{stats}
...
limits of the confidence / prediction intervals:\idxfun{mean}{base}\idxfun{nobs}{stats}\idxfun{sum}{base}\idxfun{df.residual}{stats}\idxfun{qt}{stats}\idxfun{mutate}{dplyr}\idxfun{fitted}{stats}\idxfun{sigma}{stats}\idxfun{sqrt}{base}\idxfun{mutate}{dplyr}\idxfun{select}{dplyr}
