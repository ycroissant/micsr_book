...
library and the result is a `sf`
...
There are 91 countries in the `sp_solow` data set, the series being the gdp in 1960 and 1995, the saving rate and the growth of the labor force.
...
## Spatial models {#sec-spatial_models}
