...
cat(draw3D(xo = hy, y, color = "blue", name = "\\hat{\\epsilon}_{12}=M_{12}y", lab = 0.5, pos = "right"))
...
cat(draw3D(x = x2, xo = P1x2, col = "green", lab = 0.35, pos = "above", name = "M_1x_2"))
cat(draw3D(x = bx2, xo = P1bx2, col = "red", lab = 0.5, name = "\\hat{\\beta}_2M_1x_2", pos = "below"))

P1y <- as.numeric(Pmat(x1) %*% y)
cat(draw3D(x = y, xo = P1y, col = "blue", name = "\\hat{\\epsilon}_{1}=M_1y", lab = 0.5))
cat(draw3D(x = hy, xo = P1y, col = "red", name = "P_{M_1x_2}y=\\tilde{\\beta}_2M_1x_2", lab = 0.5, pos = "above"))
