...
TIKnode(c(xmax, 0), "$z$", pos = "right")
#TIKnode(c(0, ymax), "y", pos = "above")
TIKnode(c(0, 0), "$-\\frac{\\beta'x}{\\sigma}$", pos = "below")
TIKnode(c(mu1, 0), "$0$", pos = "below")
TIKnode(c(2.5, 0.3), "$\\phi(z)$")
TIKline(list(c(2, 0.29), c(1.5, dnorm(1.5, mu1))), options = "->") 
TIKnode(c(2.9, 0.48),"$\\frac{\\phi(z)}{\\Phi\\left(\\frac{\\beta'x}{\\sigma}\\right)}$")
