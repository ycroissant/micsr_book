...
reporting.^[see @LIND:SAND:OREO:10@LIND:SAND:OREO:10\index[author]{Lindo}\index[author]{Sanders}\index[author]{Oreopoulos}, footnote 20 page 104.] We remove these misleading observations:
...
The matching estimator was first proposed by @ROSE:RUBI:83\index[author]{Rosenbaum}\index[author]{Rubin} and the interest in matching methods in econometrics really started with @DEHE:WAHB:99\index[author]{Dehejia}\index[author]{Wahba} and @DEHE:WAHB:02\index[author]{Dehejia Wahba}\index[author]{Wahba}. These two articles revisited the results of @LALO:86\index[author]{Lalonde} who showed that the estimation of treatment effect with observational data can be 
...
- mafia in southern Italy [@PINO:15]\index[author]{Pinotti} and [@BECK:KLOS:17]\index[author]{Becker}\index[author]{Klosner},
